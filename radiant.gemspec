...
a general purpose content managment system--not merely a blogging engine.}
  ...
  s.add_dependency "radiant-archive-extension",             "~> 1.0.6"
  s.add_dependency "radiant-clipped-extension",             "~> 1.0.10"
  ...
  s.add_dependency "radiant-sheets-extension",              "~> 1.0.4"
  s.add_dependency "radiant-site_templates-extension",      "~> 1.0.2"
