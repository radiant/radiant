...
a general purpose content managment system--not merely a blogging engine.}
  ...
  s.files = [
    ...
    "app/controllers/admin_controller.rb.orig",
    ...
    "lib/radiant/engine.rb.orig",
    "lib/radiant/extension.rb",
    "lib/radiant/extension.rb.orig",
  ...
  s.rdoc_options = ["--title", "Radiant -- Publishing for Small Teams", "--line-numbers", "--main", "README", "--exclude", "app", "--exclude", "bin", "--exclude", "config", "--exclude", "db", "--exclude", "features", "--exclude", "lib", "--exclude", "log", "--exclude", "pkg", "--exclude", "public", "--exclude", "spec", "--exclude", "spec-rails2", "--exclude", "test", "--exclude", "vendor"]
  s.require_paths = ["lib"]
