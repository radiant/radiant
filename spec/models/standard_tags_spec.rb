...
#   let(:file_not_found){ FactoryGirl.create(:file_not_found_page, parent_id: home.id, :slug => '404', :published_at => Time.now, :status_id => Status[:published].id)}
  ...
  [:title, :dev_host, :host].each do |attr|
    it "<r:site:#{attr}> should render the '#{attr}' attribute from Radiant.detail" do
      ...
      page.should render("<r:site:#{attr} />").as(value)
    end
  end
  ...
  it '<r:parent> should change the local context to the parent page' do
    ...
    parent.should render('<r:children:each><r:parent:title /></r:children:each>').as(parent.title * parent.children.count)
  end
  ...
  it '<r:if_children> should render the contained block if the current page has child pages' do
    radius.should render('<r:if_children>true</r:if_children>').as('')
  ...
  it '<r:unless_children> should render the contained block if the current page has no child pages' do
    radius.should render('<r:unless_children>true</r:unless_children>').as('true')
  ...
  describe "<r:children:each>" do
    it "should iterate through the children of the current page" do
      child; child_2; child_3
      parent.should render('<r:children:each><r:title /> </r:children:each>').as('Child Child 2 Child 3 ')
      parent.should render('<r:children:each><r:page><r:slug />/<r:child:slug /> </r:page></r:children:each>').as('parent/child parent/child-2 parent/child-3 ')
    end
    ...
    describe 'with paginated="true"' do
      ...
      it 'should pass through selected will_paginate parameters' do
        ...
        assorted.should render('<r:children:each paginated="true" inner_window="1" outer_window="0"><r:slug /> </r:children:each>').not_matching(/\?p=2/)
      end
    end
    ...
    it "should limit the number of children when given a 'limit' attribute" do
      a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_each_tags(%{limit="5"})).as('a b c d e ')
    end

    it "should limit and offset the children when given 'limit' and 'offset' attributes" do
      a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_each_tags(%{offset="3" limit="5"})).as('d e f g h ')
    end

    it "should change the sort order when given an 'order' attribute" do
      a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_each_tags(%{order="desc"})).as('j i h g f e d c b a ')
    end

    it "should sort by the 'by' attribute" do
      a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_each_tags(%{by="breadcrumb"})).as('f e d c b a j i h g ')
    end

    it "should sort by the 'by' attribute according to the 'order' attribute" do
      a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_each_tags(%{by="breadcrumb" order="desc"})).as('g h i j a b c d e f ')
    end

    describe 'with "status" attribute' do
      it "set to 'all' should list all children" do
        article; article_2; article_3; article_4; draft
        news.should render(page_children_each_tags(%{status="all"})).as("draft article article-2 article-3 article-4 ")
      end

      it "set to 'draft' should list only children with 'draft' status" do
        article; article_2; article_3; article_4; draft
        news.should render(page_children_each_tags(%{status="draft"})).as('draft ')
      end

      it "set to 'published' should list only children with 'published' status" do
        article; article_2; article_3; article_4; draft
        news.should render(page_children_each_tags(%{status="published"})).as('article article-2 article-3 article-4 ')
      end

      it "set to an invalid status should render an error" do
        article; article_2; article_3; article_4; draft
        news.should render(page_children_each_tags(%{status="askdf"})).with_error("`status' attribute of `each' tag must be set to a valid status")
      end
    end
    ...
    xit 'should not list draft pages on dev.site.com when Radiant.detail["dev.host"] is set to something else' do
      ...
      article; article_2; article_3; article_4; draft
      page.should render('<r:children:each by="title"><r:slug /> </r:children:each>').as('article article-2 article-3 article-4 ').on('dev.site.com')
  ...
  describe "<r:children:each:if_first>" do
    it "should render for the first child" do
      ...
      news.should render(tags).as(expected)
    end
  end
  ...
  describe "<r:children:count>" do
    it 'should render the number of children of the current page' do
      child; child_2; child_3
      parent.should render('<r:children:count />').as('3')
    end

    it "should accept the same scoping conditions as <r:children:each>" do
      article; article_2; article_3; article_4; draft
      news.should render('<r:children:count />').as('4')
      news.should render('<r:children:count status="all" />').as('5')
      news.should render('<r:children:count status="draft" />').as('1')
      news.should render('<r:children:count status="hidden" />').as('0')
    end
  end
  ...
  describe "<r:children:first>" do
    it 'should render its contents in the context of the first child page' do
      child; child_2; child_3
      parent.should render('<r:children:first:title />').as('Child')
    end

    it 'should accept the same scoping attributes as <r:children:each>' do
      assorted; a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_first_tags).as('a')
      assorted.should render(page_children_first_tags(%{limit="5"})).as('a')
      assorted.should render(page_children_first_tags(%{offset="3" limit="5"})).as('d')
      assorted.should render(page_children_first_tags(%{order="desc"})).as('j')
      assorted.should render(page_children_first_tags(%{by="breadcrumb"})).as('f')
      assorted.should render(page_children_first_tags(%{by="breadcrumb" order="desc"})).as('g')
    end

    it "should render nothing when no children exist" do
      radius.should render('<r:children:first:title />').as('')
    end
  end
  ...
  describe "<r:children:last>" do
    it 'should render its contents in the context of the last child page' do
      article; article_2; article_3; article_4
      news.should render('<r:children:last:title />').as('Article 4')
    end

    it 'should accept the same scoping attributes as <r:children:each>' do
      assorted; a; b; c; d; e; f; g; h; i; j
      assorted.should render(page_children_last_tags).as('j')
      assorted.should render(page_children_last_tags(%{limit="5"})).as('e')
      assorted.should render(page_children_last_tags(%{offset="3" limit="5"})).as('h')
      assorted.should render(page_children_last_tags(%{order="desc"})).as('a')
      assorted.should render(page_children_last_tags(%{by="breadcrumb"})).as('g')
      assorted.should render(page_children_last_tags(%{by="breadcrumb" order="desc"})).as('f')
    end

    it "should render nothing when no children exist" do
      radius.should render('<r:children:last:title />').as('')
    end
  end

  describe "<r:content>" do
    it "should render the 'body' part by default" do
      home.should render('<r:content />').as('Hello world!')
    end
    ...
    it "should prevent simple recursion" do
      recursive_parts.should render('<r:content />').with_error("Recursion error: already rendering the `body' part.")
    end

    it "should prevent deep recursion" do
      recursive_parts.should render('<r:content part="one"/>').with_error("Recursion error: already rendering the `one' part.")
      recursive_parts.should render('<r:content part="two"/>').with_error("Recursion error: already rendering the `two' part.")
    end

    it "should allow repetition" do
      recursive_parts.should render('<r:content part="repeat"/>').as('xx')
    end
    ...
    describe "with inherit attribute" do
      ...
      it "should render parts with respect to the current contextual page" do
        ...
        parent.should render('<r:children:each><r:content /> </r:children:each>').as(expected)
      end
    end
  end
    ...
    describe "with more than one part given (separated by comma)" do
      ...
      describe "with the 'find' attribute set to 'all'" do
        ...
        it "should render the contained block unless all of the specified parts exist" do
          home.should render('<r:unless_content part="body, madeup" find="all">true</r:unless_content>').as('true')
        end
      end

      describe "with the 'find' attribute set to 'any'" do
        it "should not render the contained block if any of the specified parts exist" do
          home.should render('<r:unless_content part="body, madeup" find="any">true</r:unless_content>').as('')
        end
      end
    end
  end
  ...
  describe "<r:aggregate>" do
    ...
    it "should expand its contents with a given 'paths' attribute formatted as '/path1; /path2;'" do
      parent;child;page
      home.should render('<r:aggregate paths="/parent/child; /page;">true</r:aggregate>').as('true')
    end
  end
  ...
  describe "<r:aggregate:children>" do
    it "should expand its contents" do
      parent;child;page
      home.should render('<r:aggregate paths="/parent/child; /page;"><r:children>true</r:children></r:aggregate>').as('true')
    end
  end
  ...
  describe "<r:aggregate:each>" do
    it "should loop through each of the given aggregate paths" do
      ...
      home.should render('<r:aggregate paths="/parent/child; /news; /page;"><r:each><r:title /> </r:each></r:aggregate>').as('Child News Page ')
    end
    it "should display it's contents in the scope of the individually aggregated page" do
      ...
      home.should render('<r:aggregate paths="/parent; /news;"><r:each><r:children:each><r:title /> </r:children:each></r:each></r:aggregate>').as('Child Child 2 Child 3 Article Article 2 Article 3 Article 4 ')
    end
  end

  describe "<r:author>" do
    it "should render the author of the current page" do
      home.should render('<r:author />').as('Admin')
    end
  ...
  describe "<r:gravatar>" do
    it "should render the Gravatar URL of author of the current page" do
      home.should render('<r:gravatar />').as('//gravatar.com/avatar/e64c7d89f26bd1972efa854d13d7dd61?rating=G&size=32')
    end
    ...
    it "should render the specified rating" do
      home.should render('<r:gravatar rating="X" />').as('//gravatar.com/avatar/e64c7d89f26bd1972efa854d13d7dd61?rating=X&size=32')
    end
  end

  describe "<r:date>" do
    it "should render the published date of the page" do
      dated.should render('<r:date />').as('Wednesday, January 11, 2006')
    end

    it "should format the published date according to the 'format' attribute" do
      dated.should render('<r:date format="%d %b %Y" />').as('11 Jan 2006')
    end
    ...
    describe "with 'for' attribute" do
      it "set to 'now' should render the current date in the current Time.zone" do
        dated.should render('<r:date for="now" />').as(Time.zone.now.strftime("%A, %B %d, %Y"))
      end

      it "set to 'created_at' should render the creation date" do
        dated.should render('<r:date for="created_at" />').as('Tuesday, January 10, 2006')
      end

      it "set to 'updated_at' should render the update date" do
        dated.should render('<r:date for="updated_at" />').as('Thursday, January 12, 2006')
      end

      it "set to 'published_at' should render the publish date" do
        dated.should render('<r:date for="published_at" />').as('Wednesday, January 11, 2006')
      end

      it "set to an invalid attribute should render an error" do
        dated.should render('<r:date for="blah" />').with_error("Invalid value for 'for' attribute.")
      end
    end
    ...
    it "should use the currently set timezone" do
      ...
      dated.should render(%Q(<r:date format="#{format}" />) ).as(expected)
    end
  end

  describe "<r:link>" do
    it "should render a link to the current page" do
      page.should render('<r:link />').as('<a href="/page/">Page</a>')
    end

    it "should render its contents as the text of the link" do
      page.should render('<r:link>Test</r:link>').as('<a href="/page/">Test</a>')
    end
    ...
    it "should pass HTML attributes to the <a> tag" do
      ...
      page.should render(input).matching(/\ href="\/page\/"/)
      page.should render(input).matching(/\ id="bacon"/)
    end

    it "should add the anchor attribute to the link as a URL anchor" do
      page.should render('<r:link anchor="test">Test</r:link>').as('<a href="/page/#test">Test</a>')
    end
    ...
    it "should render a link for the current contextual page" do
      ...
      parent.should render('<r:children:each><r:link /> </r:children:each>' ).as(expected)
    end

    it "should scope the link within the relative URL root" do
      page.should render('<r:link />').with_relative_root('/foo').as('<a href="/foo/page/">Page</a>')
    end
  end
  ...
  it '<r:random> should render a randomly selected, dynamically set <r:option>' do
    child; child_2; child_3
    parent.should render("<r:random:children:each:option:title />").matching(/^(Child|Child\ 2|Child\ 3)$/)
  end
  ...
  describe "<r:navigation>" do
    ...
    it "should render the nested <r:selected> tag for paths that match the current page" do
      ...
      parent.should render(tags).as(expected)
    end
    ...
    it 'should prune empty blocks' do
      ...
      radius.should render(tags).as(expected)
    end
  ...
  describe "<r:find>" do
    ...
    it "should accept a path relative to the current page" do
      ...
      great_grandchild.should render(%{<r:find path="../../../child-2"><r:title/></r:find>}).as("Child 2")
    end
  end
  ...
  describe "<r:if_path>" do
    describe "with 'matches' attribute" do
      it "should render the contained block if the page URL matches" do
        page.should render('<r:if_path matches="p.ge/$">true</r:if_path>').as('true')
      end
      ...
      it "without 'ignore_case' attribute should ignore case by default" do
        page.should render('<r:if_path matches="pAgE/$">true</r:if_path>').as('true')
      end

      describe "with 'ignore_case' attribute" do
        it "set to 'true' should use a case-insensitive match" do
          page.should render('<r:if_path matches="pAgE/$" ignore_case="true">true</r:if_path>').as('true')
        end

        it "set to 'false' should use a case-sensitive match" do
          page.should render('<r:if_path matches="pAgE/$" ignore_case="false">true</r:if_path>').as('')
        end
      end
    end
  ...
  describe "<r:unless_path>" do
    describe "with 'matches' attribute" do
      it "should not render the contained block if the page URL matches" do
        page.should render('<r:unless_path matches="p.ge/$">true</r:unless_path>').as('')
      end
      ...
      it "without 'ignore_case' attribute should ignore case by default" do
        page.should render('<r:unless_path matches="pAgE/$">true</r:unless_path>').as('')
      end
      ...
      describe "with 'ignore_case' attribute" do
        ...
        it "set to 'false' should use a case-sensitive match" do
          page.should render('<r:unless_path matches="pAgE/$" ignore_case="false">true</r:unless_path>').as('true')
        end
      end
    end
  ...
  describe "<r:if_dev>" do
    ...
    it "should not render the contained block when no request is present" do
      devtags.render_part('if_dev').should_not == 'dev'
    end
  ...
  describe "<r:unless_dev>" do
    ...
    it "should render the contained block when no request is present" do
      devtags.render_part('unless_dev').should == 'not dev'
    end
  ...
  describe "<r:status>" do
    ...
    it "should render the status of the current page" do
      status_tag = "<r:status/>"
      home.should render(status_tag).as("Published")
      hidden.should render(status_tag).as("Hidden")
      draft.should render(status_tag).as("Draft")
    end
    ...
    describe "with the downcase attribute set to 'true'" do
      it "should render the lowercased status of the current page" do
        ...
        home.should render(status_tag_lc).as("published")
        hidden.should render(status_tag_lc).as("hidden")
        draft.should render(status_tag_lc).as("draft")
      end
    end
  end
